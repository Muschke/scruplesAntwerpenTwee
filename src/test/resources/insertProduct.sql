insert into producten (eigenschapId, kleurId, merkId, maatId, soort, beschrijving, aankoopprijs, status, solden,
        ...
        values ((select ideigenschap from eigenschappen where subeigenschap = 'korte broek'),
                ...
                (select idmaten from maten where maat = 'M'), 'HEREN', 'testbeschrijving', 10, 'TEKOOP', 1,
